...
*/
InDegreeStatistic::InDegreeStatistic(const NetworkProps& networkProps, int sampleSize, int iterations)
...
*/
QList<CellTriplet> InDegreeStatistic::drawTriplets(const NeuronSelection& selection) {
...
*/
void InDegreeStatistic::setInnervation(QList<CellTriplet>& triplets) {
...
*/
void InDegreeStatistic::initializeStatistics() {
...
void InDegreeStatistic::doCalculate(const NeuronSelection& selection) {
    ...
    for (int i = 0; i < mIterations; i++) {
        ...
        // InDegreeStatistic::getAverageConvergence(triplets);
...
*/
double InDegreeStatistic::calculateConnectionProbability(double innervation) {
...
*/
double InDegreeStatistic::calculateConvergence(IdList& presynapticNeurons,
...
*/
void InDegreeStatistic::calculateAverageConvergence(const NeuronSelection& selection) {
    int preLimit = 3000;
...
*/
double InDegreeStatistic::calculateAverageConvergence(IdList& presynapticNeurons,
...
*/
std::vector<std::vector<double> > InDegreeStatistic::getAverageConvergence(
...
*/
void InDegreeStatistic::computeProbabilities(
...
/**
        ...
        @param tripletMotifs The motif combinations.
*/
void InDegreeStatistic::computeExpectedProbabilities(
...
*/
void InDegreeStatistic::deleteMotifCombinations(
    std::map<unsigned int, std::list<TripletMotif*> > tripletMotifs) {
...
*/
void InDegreeStatistic::writeResult() const {
...
*/
double InDegreeStatistic::getDeviation(int motif) const {
    double deviation;
...
*/
IdList InDegreeStatistic::drawRandomly(const IdList& neuronIds, int number) {
    IdList selection;
    std::srand(std::time(NULL));
...
/**
    ...
    @return The selected IDs.
*/
IdList InDegreeStatistic::drawRandomlyExceeds(const IdList& neuronIds, int limit) {
...
*/
void InDegreeStatistic::printAverageConvergence() {
    qDebug() << "====== CONVERGENCE ======";
    for (int i = 0; i < 3; i++) {
        for (int j = 0; j < 3; j++) {
